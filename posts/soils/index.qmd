...
\
The second was focused on nutrient management. As part of my second course, I was able to create a conservation plan including cultural and traditional management techniques. I chose to focus on Rollins Fram in Columbia, Missouri since it is the location where the data was collected for my capstone project. The lower portion of the farm has a long history of flooding. Therefore, I chose to focus on decreasing the amount of nitrogen runoff and erosion. A full proposal of the plan and calculations can be seen below.

 

![](Management_Plan.pdf){fig-align="center"}

![](Calculations.pdf){fig-align="center"}
